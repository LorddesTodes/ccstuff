...
public class CCSPeripheral implements IPeripheral {
    /**
     ...
     */
    private final CCSTileEntity tileEntity;

    /**
     * @param tileEntity the tile entity of this peripheral
     */
    public CCSPeripheral(CCSTileEntity tileEntity) {
    ...
    public CCSTileEntity getTileEntity() {
        return tileEntity;
    }
